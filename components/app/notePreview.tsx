...
const renderRightActions = () => {
  return (
    <Animated.View
      entering={FadeIn}
      exiting={FadeOut}
    className="w-full h-20 justify-center items-end bg-red-600 rounded-md">
      <Pressable className="">
...
export function NotePreview({ note, query, color }: NotePreviewProps) {
  ...
  return (
    ...
    >
      <Link
        ...
        asChild
      >
        <Pressable className="w-full h-20 px-8 flex flex-col justify-center text-white rounded-md border"
