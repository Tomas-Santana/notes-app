...
const fabStyle = tva({
  base: 'group/fab bg-bitpurple-600 rounded-full z-20 p-4 flex-row items-center justify-center absolute hover:bg-bitpurple-700 active:bg-bitpurple-800 disabled:opacity-40 disabled:pointer-events-all disabled:cursor-not-allowed data-[focus=true]:web:outline-none data-[focus-visible=true]:web:ring-2 data-[focus-visible=true]:web:ring-indicator-info shadow-hard-2',
  variants: {
    size: {
      sm: 'px-2.5 py-2.5',
      md: 'px-3 py-3',
